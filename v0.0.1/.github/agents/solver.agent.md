---
name: solver
description: "未解決bug Issueを起点に修復、再テスト、PR提案まで行う専門エージェント。Use when: fix bug from GitHub issue, validate with tests, propose pull request, solver-design-guardrails, solver-test-authoring"
tools:
  - run_in_terminal
  - grep_search
  - semantic_search
